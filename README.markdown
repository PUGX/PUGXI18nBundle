...
This branch requires Symfony 2.4

[![Build Status](https://secure.travis-ci.org/PUGX/PUGXI18nBundle.png?branch=4.0)](http://travis-ci.org/PUGX/PUGXI18nBundle)
...
[Read the Documentation](https://github.com/PUGX/PUGXI18nBundle/blob/4.0/Resources/doc/index.md)

Installation
------------

All the installation instructions are located in [documentation](https://github.com/PUGX/PUGXI18nBundle/blob/4.0/Resources/doc/index.md).
